...
//        BitmapDrawable bmd = new BitmapDrawable(resizedBitmap);
     ...
     * @return
     */
    public static byte changePointPx(byte[] arry){
        byte v = 0;
        for (int i = 0; i < 8; i++) {
            v += v + arry[i];
        }
     ...
     *
     */
    public static Bitmap compressPic240(Bitmap bitmap) {
        // 获取这个图片的宽和高
...
//        int size = bmp.getWidth() * bmp.getHeight() / 8 +100;
        byte[] data = new byte[7400];//7263
        int k = 0;
//        //设置行距为0的指令
//        data[k++] = 0x1B;
//        data[k++] = 0x33;
//        data[k++] = 0x00;
     ...
     * @return
     */
    public static byte px2Byte240(int x, int y, Bitmap bit) {
